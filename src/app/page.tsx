  ...
  return (
    <div className="flex min-h-screen flex-col bg-canvas">
      ...
      <main id="main" className="flex-1">
          ...
          <Container className="relative pb-12 pt-10 md:pb-16 md:pt-16 lg:pb-20 lg:pt-20">
            <div className="grid items-center gap-14 lg:grid-cols-12 lg:gap-10">
              <div className="lg:col-span-6">
                <p className="chip mb-6 text-xs font-semibold uppercase tracking-[0.14em] text-brand-700">
                  <span
                    aria-hidden="true"
                    className="size-1.5 rounded-full bg-violet-600"
                  />
                ...
                <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
                  ...
                  <Button asChild variant="secondary" size="xl" shape="pill">
          ...
          <Container>
            ...
            <ol role="list" className="mt-10 grid gap-5 md:grid-cols-3 lg:mt-12">
              {STEPS.map((step, index) => (
                <li
                  key={step.title}
                  className="group rounded-3xl border border-white/70 bg-white/90 p-6 shadow-card backdrop-blur-sm transition-all hover:-translate-y-1 hover:shadow-lg"
                >
                  <div className="flex items-center justify-between">
                    <span className="flex size-11 items-center justify-center rounded-2xl bg-cta-gradient text-white shadow-cta">
                      <step.icon className="size-5" aria-hidden="true" />
                    </span>
                    <span
                      aria-hidden="true"
                      className="font-display text-3xl font-extrabold text-brand-100"
                    >
          ...
          <Container>
            ...
            <ul role="list" className="mt-10 grid gap-5 sm:grid-cols-2 lg:mt-12">
              {COMPARISONS.map((item) => (
                <li
                  key={item.problem}
                  className="flex gap-4 rounded-3xl border border-white/70 bg-white/90 p-6 shadow-card backdrop-blur-sm transition-all hover:-translate-y-1 hover:shadow-lg"
                >
        ...
        {/* ── Live wall ────────────────────────────────────────────────── */}
        <section id="live-wall" className="section-y">
          <Container>
           <div className="overflow-hidden rounded-[2rem] bg-ink-gradient p-6 text-white shadow-float sm:p-10 lg:p-12">
        ...
        <section className="section-y">
          <Container>
           <div className="rounded-[2rem] bg-cta-gradient px-6 py-14 text-center text-white shadow-float sm:px-12 md:py-16">
            <h2 className="mx-auto max-w-2xl font-display text-3xl font-extrabold tracking-[-0.02em] text-white sm:text-4xl lg:text-[2.75rem]">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button asChild variant="onDark" size="xl" shape="pill">
                <Link href="/signup">
                  Create your event
                  <ArrowRight aria-hidden="true" />
                </Link>
              </Button>
              <Button asChild variant="onDarkGhost" size="xl" shape="pill">
                <Link href="/join">
